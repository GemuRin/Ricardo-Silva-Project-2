...
public class PFeedsProvider extends ContentProvider {
	public static final Uri CONTENT_URI = Uri
			.parse("content://blog.masterd.pt");
	...
	public boolean onCreate() {
		...
		PFeedsSQLHelper dbHelper = new PFeedsSQLHelper(context);
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		switch (uriMatcher.match(uri)) {
		case POST:
			count = feedsDB.update(Posts.NOME_TABELA, values, selection,
					selectionArgs);
			break;
		case POST_ID:
