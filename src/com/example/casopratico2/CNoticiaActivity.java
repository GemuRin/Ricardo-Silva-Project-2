...
public class CNoticiaActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.noticiacorreio);
		titulo = (TextView) findViewById(R.id.feedTituloc);
		...
		data = (TextView) findViewById(R.id.feedDatac);
		conteudo = (WebView) findViewById(R.id.feedConteudoc);
	...
	protected void onStart() {
		...
		try {
			...
			Uri uri = CFeedsProvider.CONTENT_URI;
			...
			if (cursor.moveToPosition(id - 1)) {
				...
				java.text.DateFormat dateFormat = DateFormat
						.getLongDateFormat(CNoticiaActivity.this);
